...
foreach(FIND_SFML_COMPONENT ${SFML_FIND_COMPONENTS})
	...
	# message("Looking for ${FIND_SFML_COMPONENT_NAME}")
    ...
    if(FIND_SFML_COMPONENT_LOWER STREQUAL "main")
        ...
        find_library(SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_STATIC_RELEASE
                     ...
                     PATH_SUFFIXES lib64 lib 
                     PATHS ${FIND_SFML_PATHS})
		#message("LIBRARY_STATIC_RELEASE == ${SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_STATIC_RELEASE}")
        ...
        find_library(SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_STATIC_DEBUG
                     ...
                     PATH_SUFFIXES lib64 lib
                     PATHS ${FIND_SFML_PATHS})
		#message("LIBRARY_STATIC_DEBUG == ${SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_STATIC_DEBUG}")
    ...
    if (SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_DEBUG OR SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY_RELEASE)
		...
		message("Missing: SFML_${FIND_SFML_COMPONENT_UPPER}_LIBRARY")
    endif()
...
# 	set(SFML_LIBRARIES ${SFML_LIBRARIES} "udev;pthread;X11;Xrandr;GL;dl;${FREETYPE_LIBRARY};${JPEG_LIBRARY};${PNG_LIBRARY}") # jpeg;freetype
# endif (UNIX)
...
if(SFML_STATIC_LIBRARIES)
    ...
    macro(find_sfml_dependency output friendlyname)
		...
		message("sfml-dependency: ${output}")
    ...
    if(NOT ${FIND_SFML_GRAPHICS_COMPONENT} EQUAL -1)
        ...
        # find libraries
		find_sfml_dependency(BZIP_LIBRARY "bzip" bz2d)
		find_sfml_dependency(ZIP_LIBRARY "zlib" z)
		find_sfml_dependency(PNG_LIBRARIES "png" png16d)
        find_sfml_dependency(FREETYPE_LIBRARY "FreeType" freetype)
        find_sfml_dependency(JPEG_LIBRARY "libjpeg" jpeg)

        # update the list
        set(SFML_GRAPHICS_DEPENDENCIES ${FREETYPE_LIBRARY} ${JPEG_LIBRARY} ${PNG_LIBRARIES} ${ZIP_LIBRARY} ${BZIP_LIBRARY})
